...
# File: projects/bloom_dual_core/include/ids.xml
def IDS_BLOOM_PATTERN_LOW_REG ():        
    return 0x2000300

def IDS_BLOOM_PATTERN_HIGH_REG ():       
    return 0x2000304

def IDS_LOGIC_ANYLZ_ADDR_REG ():         
    return 0x2000308

def IDS_INST_PC_RST_PROCCESDONE1_REG (): 
    return 0x200030c

def IDS_RDWR_PTRS_INOUT_CTRLS1_REG ():   
    return 0x2000310

def IDS_FIFO_OUT11_REG ():               
    return 0x2000314

def IDS_FIFO_OUT21_REG ():               
    return 0x2000318

def IDS_IN_DATA11_REG ():                
    return 0x200031c

def IDS_IN_DATA21_REG ():                
    return 0x2000320

def IDS_INST_PC_RST_PROCCESDONE0_REG (): 
    return 0x2000324

def IDS_RDWR_PTRS_INOUT_CTRLS0_REG ():   
    return 0x2000328

def IDS_FIFO_OUT10_REG ():               
    return 0x200032c

def IDS_FIFO_OUT20_REG ():               
    return 0x2000330

def IDS_IN_DATA10_REG ():                
    return 0x2000334

def IDS_IN_DATA20_REG ():                
    return 0x2000338

def IDS_BLOOM_MATCH_COUNT_REG ():        
    return 0x200033c
...
__main__.nf_regmap.update({
    ...
    0x2000300 : "IDS_BLOOM_PATTERN_LOW_REG",
    0x2000304 : "IDS_BLOOM_PATTERN_HIGH_REG",
    0x2000308 : "IDS_LOGIC_ANYLZ_ADDR_REG",
    0x200030c : "IDS_INST_PC_RST_PROCCESDONE1_REG",
    0x2000310 : "IDS_RDWR_PTRS_INOUT_CTRLS1_REG",
    0x2000314 : "IDS_FIFO_OUT11_REG",
    0x2000318 : "IDS_FIFO_OUT21_REG",
    0x200031c : "IDS_IN_DATA11_REG",
    0x2000320 : "IDS_IN_DATA21_REG",
    0x2000324 : "IDS_INST_PC_RST_PROCCESDONE0_REG",
    0x2000328 : "IDS_RDWR_PTRS_INOUT_CTRLS0_REG",
    0x200032c : "IDS_FIFO_OUT10_REG",
    0x2000330 : "IDS_FIFO_OUT20_REG",
    0x2000334 : "IDS_IN_DATA10_REG",
    0x2000338 : "IDS_IN_DATA20_REG",
    0x200033c : "IDS_BLOOM_MATCH_COUNT_REG",
