...
package reg_defines_bloom_dual_core;
...
@EXPORT = qw(
                ...
                IN_ARB_STATE_REG
                IDS_BLOOM_PATTERN_LOW_REG
                IDS_BLOOM_PATTERN_HIGH_REG
                IDS_LOGIC_ANYLZ_ADDR_REG
                IDS_INST_PC_RST_PROCCESDONE1_REG
                IDS_RDWR_PTRS_INOUT_CTRLS1_REG
                IDS_FIFO_OUT11_REG
                IDS_FIFO_OUT21_REG
                IDS_IN_DATA11_REG
                IDS_IN_DATA21_REG
                IDS_INST_PC_RST_PROCCESDONE0_REG
                IDS_RDWR_PTRS_INOUT_CTRLS0_REG
                IDS_FIFO_OUT10_REG
                IDS_FIFO_OUT20_REG
                IDS_IN_DATA10_REG
                IDS_IN_DATA20_REG
                IDS_BLOOM_MATCH_COUNT_REG
                OQ_QUEUE_0_CTRL_REG
...
sub DEVICE_PROJ_DIR ()  { "bloom_dual_core"; }
...
sub IDS_BLOOM_PATTERN_LOW_REG ()          { 0x2000300;}
sub IDS_BLOOM_PATTERN_HIGH_REG ()         { 0x2000304;}
sub IDS_LOGIC_ANYLZ_ADDR_REG ()           { 0x2000308;}
sub IDS_INST_PC_RST_PROCCESDONE1_REG ()   { 0x200030c;}
sub IDS_RDWR_PTRS_INOUT_CTRLS1_REG ()     { 0x2000310;}
sub IDS_FIFO_OUT11_REG ()                 { 0x2000314;}
sub IDS_FIFO_OUT21_REG ()                 { 0x2000318;}
sub IDS_IN_DATA11_REG ()                  { 0x200031c;}
sub IDS_IN_DATA21_REG ()                  { 0x2000320;}
sub IDS_INST_PC_RST_PROCCESDONE0_REG ()   { 0x2000324;}
sub IDS_RDWR_PTRS_INOUT_CTRLS0_REG ()     { 0x2000328;}
sub IDS_FIFO_OUT10_REG ()                 { 0x200032c;}
sub IDS_FIFO_OUT20_REG ()                 { 0x2000330;}
sub IDS_IN_DATA10_REG ()                  { 0x2000334;}
sub IDS_IN_DATA20_REG ()                  { 0x2000338;}
sub IDS_BLOOM_MATCH_COUNT_REG ()          { 0x200033c;}
