...
`define IDS_BLOOM_PATTERN_LOW         4'h0
`define IDS_BLOOM_PATTERN_HIGH        4'h1
`define IDS_LOGIC_ANYLZ_ADDR          4'h2
`define IDS_INST_PC_RST_PROCCESDONE1  4'h3
`define IDS_RDWR_PTRS_INOUT_CTRLS1    4'h4
`define IDS_FIFO_OUT11                4'h5
`define IDS_FIFO_OUT21                4'h6
`define IDS_IN_DATA11                 4'h7
`define IDS_IN_DATA21                 4'h8
`define IDS_INST_PC_RST_PROCCESDONE0  4'h9
`define IDS_RDWR_PTRS_INOUT_CTRLS0    4'ha
`define IDS_FIFO_OUT10                4'hb
`define IDS_FIFO_OUT20                4'hc
`define IDS_IN_DATA10                 4'hd
`define IDS_IN_DATA20                 4'he
`define IDS_BLOOM_MATCH_COUNT         4'hf
